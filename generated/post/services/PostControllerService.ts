...
export class PostControllerService {
  ...
  public static listPostVoByPageUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/post/post/list/page/vo",
      body: postQueryRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
  ...
  public static listMyPostVoByPageUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/post/post/my/list/page/vo",
      body: postQueryRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
  ...
  public static searchPostVoByPageUsingPost(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/post/post/search/page/vo",
      body: postQueryRequest,
      errors: {
        401: `Unauthorized`,
        403: `Forbidden`,
